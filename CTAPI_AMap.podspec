...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/CTAPIs/CTAPI_AMap"
  ...
  s.source       = { :git => "https://github.com/CTAPIs/CTAPI_AMap.git", :tag => s.version.to_s }
  ...
  s.source_files  = "CTAPI_AMap/CTAPI_AMap/**/*.{h,m}"
